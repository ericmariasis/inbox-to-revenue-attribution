...
SAFE_NON_LOCAL_ENV = {
    ...
    "STRIPE_CONNECT_REDIRECT_URI": "https://creatorbeta.example.com/stripe/connect/callback",
    "STRIPE_WEBHOOK_SECRET": "whsec_story73_beta_live",
    "CALENDLY_WEBHOOK_SIGNING_KEY": "cal_story73_beta_live",
    "TRACKED_LINK_BASE_URL": "https://creatorbeta.example.com",
    "MAGIC_LINK_EMAIL_PROVIDER": "smtp",
    "MAGIC_LINK_BASE_URL": "https://creatorbeta.example.com",
    "MAGIC_LINK_EMAIL_FROM_EMAIL": "auth@creatorbeta.example.com",
    "MAGIC_LINK_EMAIL_SMTP_HOST": "smtp.creatorbeta.example.com",
