...
def main() -> int:
    ...
    print(
        "next_step=Paste the .gpt54pro.md file into GPT 5.4 Pro, then paste the response into the .review-response.md file and classify findings into pulled-forward blockers, planned-story adjustments, or deferred follow-ups before starting the next epic"
    )
    return 0
