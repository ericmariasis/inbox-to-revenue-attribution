...
def _render_prompt(*, packet_text: str) -> str:
    return (
        ...
        "Do not assume every risk should become new roadmap scope; distinguish recommendations that should be pulled forward before the next epic from adjustments to already-planned work and from deferred follow-ups. "
        "Do not use `pre-beta` or `post-beta` framing unless the packet explicitly requires historical context.\n\n"
        ...
        "When possible, make clear which recommendations should be pulled forward before the next epic versus deferred.\n\n"
        "## Review Questions\n\n"
...
def _render_review_response_template(*, epic_title: str) -> str:
    return (
        ...
        "- Pulled-Forward Roadmap Blockers:\n"
        "  - \n"
